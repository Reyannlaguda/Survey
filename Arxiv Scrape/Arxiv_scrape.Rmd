...
```{r}
url <- 'https://arxiv.org/search/physics?query=Architecture&searchtype=all&abstracts=show&order=-announced_date_first&size=50'
...
save(papers, file = "Arxiv_Architecture.RData")
write.csv(papers, file = "Arxiv papers on Architecture.csv") 
